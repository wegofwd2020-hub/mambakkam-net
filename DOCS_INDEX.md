...
| [ADR_004_authoring_studio_home_repo](../StudyBuddy_OnDemand/docs/ADR_004_authoring_studio_home_repo.md)       | ADR-004 (Accepted) — standalone Authoring + Reader (StudyBuddy Q) lives in its own repo, not OnDemand |
| [DESIGN_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/DESIGN_curriculum_mgmt_capability.md)         | Design for the `curriculum_mgmt` teacher capability (migration 0059) — delegating curriculum-management powers from school_admin to a chosen teacher |
| [SPEC_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/SPEC_curriculum_mgmt_capability.md)             | Spec for the `curriculum_mgmt` teacher capability (issue #358, migration 0059) — endpoint contracts, permission grants, and guard logic |
...
| [VISUAL_VALIDATION_GUIDE](../StudyBuddy_OnDemand/docs/feedback/VISUAL_VALIDATION_GUIDE.md) | Step-by-step walkthrough for visually confirming that feedback-fix items (VT-1…VT-5, GG-1, AR-1…AR-3, SR-1, AP-1…AP-5) are live on the demo site |
...
| [CURRICULUM_ONBOARDING_FLOW](../StudyBuddy_OnDemand/docs/CURRICULUM_ONBOARDING_FLOW.md)     | Flow map of how a curriculum moves from nothing to student-visible, with actor transitions at each gate |
...
| [RESPONSIVE_TARGET](../StudyBuddy_OnDemand/docs/RESPONSIVE_TARGET.md)                      | Device and surface targets for each StudyBuddy interface — so reviewers and demo audiences test on the right form factor |
...
| [FEEDBACK_TRACKER](../StudyBuddy_OnDemand/docs/feedback/FEEDBACK_TRACKER.md)                              | Running log of external-reviewer and prospective-user feedback sessions with grounded analysis and tracked action items |
| [STRATEGIC_FEEDBACK](../StudyBuddy_OnDemand/docs/feedback/STRATEGIC_FEEDBACK.md)                          | Strategic and market-direction feedback from reviewers — market wedges, competitive positioning, and partnership leads |
...
| [PROMO_CANONICAL_OVERVIEW (StudyBuddy)](../StudyBuddy_OnDemand/docs/PROMO_CANONICAL_OVERVIEW.md) | Canonical StudyBuddy product overview for pasting into promo-drafting sessions — teacher emails, one-pagers, investor decks             |
| [PROMO_CANONICAL_OVERVIEW (mambakkam)](PROMO_CANONICAL_OVERVIEW.md)                            | Canonical mambakkam.net overview for pasting into promo/outreach drafting sessions — diaspora emails, visitor one-pagers                |
| [WHATSAPP_DEMO_INVITE](../StudyBuddy_OnDemand/docs/outreach/WHATSAPP_DEMO_INVITE.md)           | Reusable WhatsApp message template (bold/italic-formatted) for inviting people to try the live StudyBuddy demo                          |
...
| [RESUME](../StudyBuddy_OnDemand/docs/RESUME.md)                    | Git-tracked work-state checkpoint — portable summary of current branch and open tasks for context-reset recovery |
...
| 2026-06-06 | 1.4     | Nightly drift sweep: +12 rows (§6 ×3 ADR-004 + curriculum_mgmt DESIGN + SPEC, §9 ×1 VISUAL_VALIDATION_GUIDE, §10 ×1 CURRICULUM_ONBOARDING_FLOW, §11 ×1 RESPONSIVE_TARGET, §13 ×2 FEEDBACK_TRACKER + STRATEGIC_FEEDBACK, §14 ×3 PROMO_CANONICAL_OVERVIEW ×2 + WHATSAPP_DEMO_INVITE, §15 ×1 RESUME), -0 rows. |
