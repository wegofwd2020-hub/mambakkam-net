...
| [DESIGN_thittam_demo](docs/DESIGN_thittam_demo.md)                                                            | Static click-through Thittam demo at `/demos/thittam`: recorded fixtures, Next `output: export`, no backend  |
| [PLAN_thittam_demo](docs/PLAN_thittam_demo.md)                                                                | Task-by-task implementation plan for the Thittam static demo (9 tasks across the thittam and mambakkam-net repos) |
