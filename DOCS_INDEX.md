...
| [DESIGN_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/DESIGN_curriculum_mgmt_capability.md)         | Design doc for the `curriculum_mgmt` capability — lets a school_admin delegate curriculum-management powers to a chosen teacher (migration 0059, implemented).  |
| [ADR_004](../StudyBuddy_OnDemand/docs/ADR_004_authoring_studio_home_repo.md)                                  | Architecture Decision Record #4 — home repo for the standalone authoring + reader (StudyBuddy Q, not OnDemand); status: Accepted 2026-05-26.                    |
...
| [VISUAL_VALIDATION_GUIDE](../StudyBuddy_OnDemand/docs/feedback/VISUAL_VALIDATION_GUIDE.md)                    | Step-by-step visual walkthrough to confirm FEEDBACK_TRACKER.md fixes (VT-1–VT-5, GG-1, AR-1–AR-3, SR-1, AP-1–AP-5) shipped correctly.                         |
...
| [CURRICULUM_ONBOARDING_FLOW](../StudyBuddy_OnDemand/docs/CURRICULUM_ONBOARDING_FLOW.md)     | Flow map tracing curriculum from creation to student-accessible, including role-based approval gates (grounded in live backend as of 2026-05-21).               |
...
| [RESPONSIVE_TARGET](../StudyBuddy_OnDemand/docs/RESPONSIVE_TARGET.md)                      | Device and surface target matrix for each StudyBuddy interface — expected screen/device context so reviewers and demo audiences test correctly.                 |
| [SPEC_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/SPEC_curriculum_mgmt_capability.md) | Implementation spec for the `curriculum_mgmt` capability (migration 0059, issue #358) — API contracts, permission rules, and test coverage.              |
...
| [FEEDBACK_TRACKER](../StudyBuddy_OnDemand/docs/feedback/FEEDBACK_TRACKER.md)               | Running log of external-reviewer and prospective-user feedback on the live product, with grounded analysis and tracked action items.                             |
| [STRATEGIC_FEEDBACK](../StudyBuddy_OnDemand/docs/feedback/STRATEGIC_FEEDBACK.md)           | Strategic and market-direction feedback — competitive positioning bets, product wedges, and partnership leads from reviewers and prospective users.              |
...
| [PROMO_CANONICAL_OVERVIEW (StudyBuddy)](../StudyBuddy_OnDemand/docs/PROMO_CANONICAL_OVERVIEW.md) | StudyBuddy canonical overview for promo work — single source-of-truth to paste into Claude.ai when drafting teacher emails, one-pagers, or investor content. |
| [WHATSAPP_DEMO_INVITE](../StudyBuddy_OnDemand/docs/outreach/WHATSAPP_DEMO_INVITE.md)          | Reusable WhatsApp message template (WhatsApp-formatted bold/italic) for inviting people to try the live StudyBuddy demo.                                      |
| [PROMO_CANONICAL_OVERVIEW (mambakkam-net)](PROMO_CANONICAL_OVERVIEW.md)                       | mambakkam.net canonical overview for promo and outreach work — single source-of-truth for diaspora outreach emails and visitor content.                       |
...
| [RESUME](../StudyBuddy_OnDemand/docs/RESUME.md)                    | Git-tracked machine-agnostic checkpoint for resuming work across Claude Code sessions; updated per session.                                                   |
...
| 2026-06-02 | 1.4     | Nightly drift sweep: +12 rows (§6: +2, §9: +1, §10: +1, §11: +2, §13: +2, §14: +3, §15: +1), -0 rows.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
