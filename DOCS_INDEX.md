...
| [ADR_004_authoring_studio_home_repo](../StudyBuddy_OnDemand/docs/ADR_004_authoring_studio_home_repo.md)       | Architecture Decision Record #4 — standalone authoring + reader belongs in StudyBuddy Q, not OnDemand (accepted 2026-05-26) |
| [DESIGN_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/DESIGN_curriculum_mgmt_capability.md)         | Design for the `curriculum_mgmt` teacher-capability that lets school_admin delegate curriculum powers to a teacher (migration 0059) |
| [SPEC_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/SPEC_curriculum_mgmt_capability.md)             | Spec for the `curriculum_mgmt` teacher-capability — role grants, endpoint changes, migration 0059, issue #358 |
...
| [RESPONSIVE_TARGET](../StudyBuddy_OnDemand/docs/RESPONSIVE_TARGET.md) | Device-target matrix per StudyBuddy surface — reference for reviewers and demo audiences testing on the right device |
| [VISUAL_VALIDATION_GUIDE](../StudyBuddy_OnDemand/docs/feedback/VISUAL_VALIDATION_GUIDE.md) | Step-by-step walkthrough to visually confirm the 2026-05-24 visual-fix items (VT/GG/AR/SR/AP) are live |
...
| [CURRICULUM_ONBOARDING_FLOW](../StudyBuddy_OnDemand/docs/CURRICULUM_ONBOARDING_FLOW.md)     | Flow map showing how curriculum transitions from creation to student-visible — role permissions per step as of 2026-05-21 |
...
| [FEEDBACK_TRACKER](../StudyBuddy_OnDemand/docs/feedback/FEEDBACK_TRACKER.md)                               | Running log of external-reviewer and prospective-user feedback with grounded analysis and tracked action items |
| [STRATEGIC_FEEDBACK](../StudyBuddy_OnDemand/docs/feedback/STRATEGIC_FEEDBACK.md)                           | Strategic and market-direction feedback from reviewers — product wedges, competitive positioning, partnership leads |
...
| [PROMO_CANONICAL_OVERVIEW (StudyBuddy)](../StudyBuddy_OnDemand/docs/PROMO_CANONICAL_OVERVIEW.md) | Single-source promo context for StudyBuddy — teacher/admin one-pagers, investor talking points, and copy seeds for outreach |
| [PROMO_CANONICAL_OVERVIEW (mambakkam)](PROMO_CANONICAL_OVERVIEW.md)                             | Single-source promo context for mambakkam.net — diaspora outreach emails, visitor and resident blurbs |
| [WHATSAPP_DEMO_INVITE](../StudyBuddy_OnDemand/docs/outreach/WHATSAPP_DEMO_INVITE.md)            | Reusable WhatsApp message template for inviting people to the live StudyBuddy demo |
...
| [RESUME](../StudyBuddy_OnDemand/docs/RESUME.md)                    | Git-tracked checkpoint for resuming work on any machine — records current branch, last commit, and open threads |
...
| 2026-06-03 | 1.4     | Nightly drift sweep: +12 rows (§6 +3: ADR-004, DESIGN/SPEC curriculum_mgmt; §9 +2: RESPONSIVE_TARGET, VISUAL_VALIDATION_GUIDE; §10 +1: CURRICULUM_ONBOARDING_FLOW; §13 +2: FEEDBACK_TRACKER, STRATEGIC_FEEDBACK; §14 +3: PROMO_CANONICAL_OVERVIEW ×2, WHATSAPP_DEMO_INVITE; §15 +1: RESUME), -0 rows. |
