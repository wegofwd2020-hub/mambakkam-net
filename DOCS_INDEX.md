...
| [ADR_004](../StudyBuddy_OnDemand/docs/ADR_004_authoring_studio_home_repo.md)                                  | Architecture Decision Record #4 — establishes StudyBuddy Q (not OnDemand) as the home repo for the standalone authoring + reader |
| [DESIGN_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/DESIGN_curriculum_mgmt_capability.md)         | Design for the `curriculum_mgmt` teacher capability (migration 0059) — school_admin delegation of curriculum-management powers   |
| [SPEC_curriculum_mgmt_capability](../StudyBuddy_OnDemand/docs/SPEC_curriculum_mgmt_capability.md)             | Implementation spec for the `curriculum_mgmt` capability (issue #358) — endpoints, permission model, and RLS rules              |
...
| [VISUAL_VALIDATION_GUIDE](../StudyBuddy_OnDemand/docs/feedback/VISUAL_VALIDATION_GUIDE.md) | Step-by-step visual walkthrough to confirm that UI-fix items from FEEDBACK_TRACKER.md actually shipped in the live demo |
...
| [CURRICULUM_ONBOARDING_FLOW](../StudyBuddy_OnDemand/docs/CURRICULUM_ONBOARDING_FLOW.md)     | End-to-end flow map — how a curriculum progresses from nothing to student-visible, with role-permission boundaries at each transition |
...
| [RESPONSIVE_TARGET](../StudyBuddy_OnDemand/docs/RESPONSIVE_TARGET.md)                      | Device and surface target matrix — where each StudyBuddy surface is expected to run, so reviewers test on the right device  |
...
| [STRATEGIC_FEEDBACK](../StudyBuddy_OnDemand/docs/feedback/STRATEGIC_FEEDBACK.md)                          | Strategic and market-direction feedback from reviewers — market wedges, competitive positioning bets, and partnership leads         |
...
| [PROMO_CANONICAL_OVERVIEW (StudyBuddy)](../StudyBuddy_OnDemand/docs/PROMO_CANONICAL_OVERVIEW.md) | Single source-of-truth context block for drafting StudyBuddy promo material — teacher emails, school admin one-pagers, investor snippets  |
| [WHATSAPP_DEMO_INVITE](../StudyBuddy_OnDemand/docs/outreach/WHATSAPP_DEMO_INVITE.md)            | WhatsApp-formatted invite template for sharing the live StudyBuddy demo with prospective users                                             |
| [PROMO_CANONICAL_OVERVIEW (mambakkam)](PROMO_CANONICAL_OVERVIEW.md)                             | Single source-of-truth context block for drafting mambakkam.net promo and outreach material                                                |
...
| [RESUME](../StudyBuddy_OnDemand/docs/RESUME.md)                    | Git-tracked work-resume checkpoint — current branch, open tasks, and next steps so work can continue from any machine |
...
| 2026-06-07 | 1.4     | Nightly drift sweep: +12 rows (§6 +3, §9 +1, §10 +1, §11 +1, §13 +2, §14 +3, §15 +1), -0 rows. |
