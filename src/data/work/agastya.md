...
# Link-preview card (scripts/og/cards/agastya.html). Without this the page
# inherits the site default and shares as the village photo.
ogImage: ~/assets/images/work/agastya-og.png
